...
const ConsortiumProperty = () => {
  ...
  const benefits = [
    ...
    "Crédito corrigido pelo mercado",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-5xl font-bold">Consórcio Imobiliário</h1>
            </div>
            <p className="text-xl text-white/90 mb-8">
              Conquiste sua casa própria ou invista em imóveis com segurança.
            </p>
            <p className="text-lg text-white/80 mb-6">
              O consórcio imobiliário é a forma mais inteligente de realizar o sonho da casa própria. 
              Com parcelas fixas e sem juros, você pode planejar seu futuro com tranquilidade.
            </p>
            <Button 
              variant="hero" 
              size="lg"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-4">
              ...
              <Card>
                <CardContent className="p-6">
                  <p className="text-muted-foreground">
                    • Você escolhe o imóvel que deseja e o prazo.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <p className="text-muted-foreground">
                    • Liberdade para realizar construções, reformas ou comprar seu imóvel.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-primary mb-8">
              Confira as vantagens de adquirir um imóvel através do consórcio!
            </h2>
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-primary text-white max-w-4xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="mb-4">
                Os grupos de consórcio imobiliário são formados mediante proposta de adesão, com preço e condições estabelecidas em assembleia pelo grupo de consorciados.
              </p>
...
export default ConsortiumProperty;
