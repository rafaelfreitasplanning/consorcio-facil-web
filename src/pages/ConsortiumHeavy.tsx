...
import { Truck, Check, ChevronLeft } from "lucide-react";
import { useNavigate } from "react-router-dom";
import logoPlanning from "@/assets/logo-planning-final.png";

const ConsortiumHeavy = () => {
  ...
  const benefits = [
    ...
    "Caminhões e utilitários pesados",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h1 className="text-5xl font-bold">Consórcio de Pesados</h1>
            </div>
            <p className="text-xl text-white/90 mb-8">
              A maneira mais fácil e barata de você expandir seus negócios você vai encontrar conversando com os consultores da Planning Consórcio.
            </p>
            <p className="text-lg text-white/80 mb-6">
              Adquira caminhões e veículos comerciais para expandir seu negócio com as melhores condições do mercado.
            </p>
            <Button 
              variant="hero" 
              size="lg"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-4">
              ...
              <Card>
                <CardContent className="p-6">
                  <p className="text-muted-foreground">
                    • Você escolhe o veículo pesado que deseja e o prazo.
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="p-6">
                  <p className="text-muted-foreground">
                    • Expande seu negócio com condições especiais para empresas.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-primary mb-8">
              Confira as vantagens de adquirir veículos pesados através do consórcio!
            </h2>
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-primary text-white max-w-4xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="mb-4">
                Os grupos de consórcio de veículos pesados são formados mediante proposta de adesão, com preço e condições estabelecidas em assembleia pelo grupo de consorciados.
              </p>
...
export default ConsortiumHeavy;
